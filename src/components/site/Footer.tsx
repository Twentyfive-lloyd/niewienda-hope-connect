  ...
  return (
    <footer className="mt-24 bg-navy text-primary-foreground">
      <div className="container-site py-16 grid gap-12 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li><Link to="/" className="hover:text-sage-soft">{t("nav.home")}</Link></li>
            <li><Link to="/notre-mission" className="hover:text-sage-soft">{t("nav.mission")}</Link></li>
            <li><Link to="/nos-actions" className="hover:text-sage-soft">{t("nav.actions")}</Link></li>
            <li><Link to="/comprendre-le-diabete" className="hover:text-sage-soft">{t("nav.understand")}</Link></li>
            <li><Link to="/nous-soutenir" className="hover:text-sage-soft">{t("nav.support")}</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-primary-foreground/85">
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:Niewienda.health@gmail.com" className="hover:text-sage-soft break-all">Niewienda.health@gmail.com</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-white/10">
        <div className="container-site flex flex-col md:flex-row items-center justify-between gap-4 py-6 text-xs text-primary-foreground/70">
          <div>© {year} Niewienda Health e.V. — {t("footer.rights")}</div>
          <div className="flex items-center gap-6">
            <a href="#" className="hover:text-sage-soft">{t("footer.legal")}</a>
            <a href="#" className="hover:text-sage-soft">{t("footer.privacy")}</a>
          </div>
        </div>
      </div>
    </footer>

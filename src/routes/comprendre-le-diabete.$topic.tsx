      ...
      <section className="relative -mt-20 h-[52vh] min-h-[400px] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex h-full items-end pb-14">
          <div className="container-site text-primary-foreground max-w-3xl">
            ...
            <h1 className="mt-5 font-display text-5xl leading-[1.05] md:text-6xl xl:text-7xl">{topic.title[lang]}</h1>
          </div>
        </div>
      </section>
      ...
      <article className="py-20 md:py-28">
        <div className="container-prose">
          ...
          <div className="mt-16 space-y-14">
            {sections.map((s, i) => (
              <section key={i}>
                ...
                {s.callout && (
                  <aside className="mt-8 rounded-2xl border border-sage/30 bg-sage-soft/40 p-6">
          ...
          <div className="mt-20 grid gap-4 border-t border-border pt-10 sm:grid-cols-2">
            {prev ? (
              <Link to="/comprendre-le-diabete/$topic" params={{ topic: prev.slug }} className="group rounded-2xl border border-border bg-background p-6 hover:border-sage">
            ...
            {next && (
              <Link to="/comprendre-le-diabete/$topic" params={{ topic: next.slug }} className="group rounded-2xl border border-border bg-background p-6 text-right hover:border-sage sm:col-start-2">
          ...
          {/* Final CTA */}
          <div className="mt-16 rounded-3xl bg-navy p-10 text-primary-foreground text-center">
